...
# Main page heading
st.header("Try Our Detection and Segmentation Models on Your Preferred Source")
...
with st.sidebar.expander("Model Settings", expanded=True):
    st.write("Configure the model settings below:")
    confidence = float(st.slider(
        "Select Model Confidence (%)", 25, 100, 40)) / 100
    st.write(f"Current Confidence: {confidence * 100:.0f}%")
